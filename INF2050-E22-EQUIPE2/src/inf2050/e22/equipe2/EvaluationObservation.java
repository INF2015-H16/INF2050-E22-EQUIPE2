...
public class EvaluationObservation {
    ...
    public static final String MSG_DATE = "L’écart maximal entre les dates" +
            " de mesure" +
            " des lots d’un même terrain devrait être de moins de 6 mois.";
    public static final String MSG = "La taxe scolaire payable" +
    ...
    public static final String LA_SUPERFFICIE_DU_LOT = "La superficie du ";
